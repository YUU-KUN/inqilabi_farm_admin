                  ...
                  >
                      ...
                      <template #cell(status)="data">
                          <span v-if="data.item.status == 'pending'" class="d-flex">
                              <button @click="approve(data.item.id)" class="btn btn-success btn-sm mx-1">V</button>
                              <button @click="reject(data.item.id)" class="btn btn-danger btn-sm mx-1">X</button>
                          </span>
                          <!-- <span v-else> -->
